...
const SQL = [
  ...
  `DEFINE FIELD IF NOT EXISTS facets ON term TYPE object`,
  `DEFINE FIELD IF NOT EXISTS embedding ON term TYPE array<float>`,
  ...
  `DEFINE FIELD IF NOT EXISTS facets ON framework TYPE object`,
  `DEFINE FIELD IF NOT EXISTS embedding ON framework TYPE array<float>`,
  ...
  `DEFINE FIELD IF NOT EXISTS facets ON industry TYPE object`,
  `DEFINE FIELD IF NOT EXISTS embedding ON industry TYPE array<float>`,
  ...
  `DEFINE FIELD IF NOT EXISTS facets ON entity TYPE object`,
