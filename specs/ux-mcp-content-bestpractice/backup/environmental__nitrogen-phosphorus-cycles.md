...
<div class="infobox">
  <div class="infobox-header">Biogeochemical Flows</div>
  ...
  <div class="infobox-row">
    <div class="infobox-label">Control Variables:</div>
    <div class="infobox-value">N & P flows to oceans</div>
  </div>
  <div class="infobox-row">
    <div class="infobox-label">Related SDGs:</div>
    <div class="infobox-value">2, 6, 12, 14</div>
  </div>
  <div class="infobox-row">
...
The [Nitrates Directive](https://ec.europa.eu/environment/water/water-nitrates/index_en.html) aims to protect water quality by preventing nitrate pollution from agricultural sources. Member states must:
...
The [SASB Agricultural Products standard](https://sasb.ifrs.org/standards/download/) includes metrics relevant to nutrient management:

**FB-AG-140a.1**: Amount of fertilizers applied (tonnes)
**FB-AG-140a.2**: Percentage of fertilizer applied in accordance with best management practices
**FB-AG-140a.3**: Discussion of strategy to manage soil nutrients and prevent eutrophication
...
- [Water Resources](/environmental/water/) — Nutrient pollution impacts
- [Ocean Acidification](/environmental/ocean-acidification/) — Marine ecosystem effects
- [Climate Change](/environmental/climate-change/) — N₂O emissions
- [SASB Standards](/standards/sasb/) — Industry-specific metrics
