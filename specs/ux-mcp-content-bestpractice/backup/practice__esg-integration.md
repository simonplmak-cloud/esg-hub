...
- [PRI ESG Integration](https://www.unpri.org/investment-tools/listed-equity/esg-integration)
...
<div class="related-grid">
  <a href="/practice/materiality-assessment/" class="related-card">
    ...
    <div class="related-card-description">Foundation for ESG strategy</div>
  </a>
  
  <a href="/practice/target-setting/" class="related-card">
    <div class="related-card-icon">📈</div>
    <div class="related-card-title">Target Setting</div>
    <div class="related-card-description">Ambitious targets drive strategic integration</div>
  </a>
  
  <a href="/governance/board-structure/" class="related-card">
    <div class="related-card-icon">🏛️</div>
    <div class="related-card-title">Board Structure</div>
    <div class="related-card-description">Board oversight of ESG strategy</div>
  </a>
</div>
