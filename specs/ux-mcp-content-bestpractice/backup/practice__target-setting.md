...
**Primary Source**: [SBTi Corporate Manual](https://sciencebasedtargets.org/resources/files/SBTi-Corporate-Manual.pdf)
...
<div class="related-grid">
  <a href="/standards/sbti/" class="related-card">
    ...
    <div class="related-card-description">Science Based Targets initiative for climate</div>
  </a>
  
  <a href="/environmental/climate-change/" class="related-card">
    <div class="related-card-icon">🌍</div>
    <div class="related-card-title">Climate Change</div>
    <div class="related-card-description">Climate targets and net-zero pathways</div>
  </a>
  
  <a href="/practice/data-management/" class="related-card">
    <div class="related-card-icon">📊</div>
    <div class="related-card-title">Data Management</div>
    <div class="related-card-description">Reliable data is essential for target tracking</div>
  </a>
</div>
