...
- [XBRL International — Digital Reporting](https://www.xbrl.org/)
...
<div class="related-grid">
  <a href="/practice/assurance-verification/" class="related-card">
    <div class="related-card-icon">✓</div>
    <div class="related-card-title">Assurance & Verification</div>
    <div class="related-card-description">Data quality is essential for assurance</div>
  </a>
  
  <a href="/standards/ghg-protocol/" class="related-card">
    <div class="related-card-icon">📊</div>
    <div class="related-card-title">GHG Protocol</div>
    <div class="related-card-description">Standard for GHG emissions data collection</div>
  </a>
  
  <a href="/environmental/climate-change/" class="related-card">
    <div class="related-card-icon">🌍</div>
    <div class="related-card-title">Climate Change</div>
    <div class="related-card-description">Climate data management for Scope 1/2/3</div>
  </a>
</div>
