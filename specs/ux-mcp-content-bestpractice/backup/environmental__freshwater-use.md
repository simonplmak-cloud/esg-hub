...
<div class="infobox">
  <div class="infobox-header">Freshwater Use</div>
  ...
  <div class="infobox-row">
    ...
    <div class="infobox-value">4,000 km³/year</div>
  </div>
  <div class="infobox-row">
    <div class="infobox-label">Current Use:</div>
    <div class="infobox-value">~2,600 km³/year</div>
  </div>
  <div class="infobox-row">
    <div class="infobox-label">Related SDGs:</div>
    <div class="infobox-value">6, 12, 13</div>
  </div>
  <div class="infobox-row">
...
The [CDP Water Security](https://www.cdp.net/en/water) questionnaire has become a standard for corporate water disclosure, with over 4,000 companies reporting annually on water risks, management strategies, and performance.
...
The [World Resources Institute's Aqueduct](https://www.wri.org/aqueduct) tool is the leading platform for assessing water risks globally. Aqueduct 4.0 (released 2023) evaluates water risk across 13 indicators grouped into three categories:
...
**Physical Risk Quality (2 indicators)**:
9. Untreated connected wastewater
10. Coastal eutrophication potential

**Regulatory & Reputational Risk (3 indicators)**:
11. Unimproved/no drinking water
12. Unimproved/no sanitation
13. Peak RepRisk ESG risk index
...
Effective water stewardship goes beyond operational efficiency to encompass watershed-level collaboration and community engagement. The [Alliance for Water Stewardship (AWS) Standard](https://a4ws.org/the-aws-standard-2-0/) provides a comprehensive framework across five steps:
...
- [Water Resources & Stewardship](/environmental/water/) — Corporate water management
- [Climate Change](/environmental/climate-change/) — Impacts on water cycle
- [GRI 303](/standards/gri/) — Water disclosure standard
