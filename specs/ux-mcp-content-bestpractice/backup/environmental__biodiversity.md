...
1. **Avoid**: Prevent biodiversity impacts at source (site selection, design)
2. **Minimize**: Reduce impacts through operational controls
3. **Restore**: Rehabilitate degraded ecosystems on-site
4. **Offset**: Compensate for residual impacts through biodiversity credits
