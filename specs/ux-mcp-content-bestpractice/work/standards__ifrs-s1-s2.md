...
The **IFRS Sustainability Disclosure Standards** (IFRS S1 and S2) establish the global baseline for sustainability-related financial disclosures, issued by the International Sustainability Standards Board (ISSB) in June 2023. These standards require entities to disclose material information about sustainability-related risks and opportunities that could affect enterprise value, with IFRS S1 providing general requirements and IFRS S2 focusing specifically on climate-related disclosures.[^1][^2]
...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://www.ifrs.org/content/dam/ifrs/publications/pdf-standards-issb/english/2023/issued/part-a/issb-2023-a-ifrs-s1-general-requirements-for-disclosure-of-sustainability-related-financial-information.pdf" class="source-title">IFRS S1 General Requirements for Disclosure of Sustainability-related Financial Information</a>
      <div class="source-meta">ISSB | June 2023 | Official Standard</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ifrs.org/content/dam/ifrs/publications/pdf-standards-issb/english/2023/issued/part-a/issb-2023-a-ifrs-s2-climate-related-disclosures.pdf" class="source-title">IFRS S2 Climate-related Disclosures</a>
      <div class="source-meta">ISSB | June 2023 | Official Standard</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ifrs.org/sustainability/knowledge-hub/introduction-to-issb-and-ifrs-sustainability-disclosure-standards/" class="source-title">Introduction to ISSB and IFRS Sustainability Disclosure Standards</a>
      <div class="source-meta">IFRS Foundation | Official Knowledge Hub</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/" class="source-title">IFRS Sustainability Standards Navigator</a>
      <div class="source-meta">IFRS Foundation | Interactive Standard Explorer</div>
    </div>
  </div>
</div>
...
<div class="book-card">
  ...
  <div class="book-info">
    <div class="book-title">ESG Reporting Made Simple (IFRS/SASB)</div>
    <div class="book-description">Practical guide to implementing IFRS S1 and S2 with SASB Standards integration. Includes materiality assessment frameworks, Scope 3 measurement methodologies, and scenario analysis templates.</div>
    <a href="/books/" class="book-download">View Book Details</a>
  </div>
</div>
...
<div class="book-card">
  <div class="book-cover">📗</div>
  <div class="book-info">
    <div class="book-title">ESG & GRI Reporting Made Simple</div>
    <div class="book-description">Comparative analysis of IFRS S1/S2 and GRI Standards, with mapping tables and dual-reporting strategies for entities subject to multiple frameworks.</div>
    <a href="/books/" class="book-download">View Book Details</a>
  </div>
</div>
...
<div class="related-grid">
  <a href="/standards/gri/" class="related-card">
    <div class="related-card-icon">📊</div>
    <div class="related-card-title">GRI Standards</div>
    <div class="related-card-description">Impact materiality framework complementary to IFRS S1/S2</div>
  </a>
  
  <a href="/standards/tcfd/" class="related-card">
    <div class="related-card-icon">🌡️</div>
    <div class="related-card-title">TCFD</div>
    <div class="related-card-description">Foundation for IFRS S2 climate disclosures</div>
  </a>
  
  <a href="/standards/sasb/" class="related-card">
    <div class="related-card-icon">🏭</div>
    <div class="related-card-title">SASB Standards</div>
    <div class="related-card-description">Industry-specific metrics integrated into IFRS S1</div>
  </a>
  
  <a href="/standards/esrs/" class="related-card">
    <div class="related-card-icon">🇪🇺</div>
    <div class="related-card-title">ESRS</div>
    <div class="related-card-description">EU standards designed for interoperability with ISSB</div>
  </a>
  
  <a href="/standards/climate-nature/ghg-protocol/" class="related-card">
    <div class="related-card-icon">📏</div>
    <div class="related-card-title">GHG Protocol</div>
    <div class="related-card-description">Emissions measurement methodology for IFRS S2</div>
  </a>
  
  <a href="/hk-apac/hkex-esg-code/" class="related-card">
    <div class="related-card-icon">🇭🇰</div>
    <div class="related-card-title">HKEX ESG Code</div>
    <div class="related-card-description">Hong Kong implementation of ISSB Standards</div>
  </a>
</div>
...
[^1]: [IFRS S1 General Requirements](https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s1-general-requirements/) — IFRS Foundation
[^2]: [IFRS S2 Climate-related Disclosures](https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s2-climate-related-disclosures/) — IFRS Foundation
[^3]: [IFRS S1 Official Standard (PDF)](https://www.ifrs.org/content/dam/ifrs/publications/pdf-standards-issb/english/2023/issued/part-a/issb-2023-a-ifrs-s1-general-requirements-for-disclosure-of-sustainability-related-financial-information.pdf) — ISSB, June 2023
[^4]: [IAS Plus: IFRS S1 Summary](https://www.iasplus.com/en/standards/ifrs-sds/ifrs-s1) — Deloitte, June 2023
[^5]: [IFRS S2 Official Standard (PDF)](https://www.ifrs.org/content/dam/ifrs/publications/pdf-standards-issb/english/2023/issued/part-a/issb-2023-a-ifrs-s2-climate-related-disclosures.pdf) — ISSB, June 2023
[^6]: [What You Need to Know About IFRS S2](https://www.ey.com/en_us/insights/ifrs/what-you-need-to-know-about-new-issb-standard-ifrs-s2) — EY, June 2023
[^7]: [Introduction to ISSB and IFRS Sustainability Disclosure Standards](https://www.ifrs.org/sustainability/knowledge-hub/introduction-to-issb-and-ifrs-sustainability-disclosure-standards/) — IFRS Foundation
[^8]: [IOSCO Endorsement of ISSB Standards](https://www.iosco.org/news/pdf/IOSCONEWS703.pdf) — IOSCO, July 2023
[^9]: [Overview of IFRS S1 and IFRS S2](https://www.grantthornton.global/en/insights/articles/overview-of-ifrs-s1-and-ifrs-s2/) — Grant Thornton, August 2023
[^10]: [IFRS S1 and IFRS S2 Key Differences and Deadlines](https://www.mitigasolutions.com/blog/ifrs-s1-and-ifrs-s2) — Mitiga Solutions, October 2025
[^11]: [ISSB Issues Sustainability Disclosure Standards](https://dart.deloitte.com/USDART/home/news/all-news/2023/jun/issb-sustainability-disclosure-standards) — Deloitte DART, June 2023
[^12]: [HKEX Climate Disclosure Enhancement (2024 announcement)](https://www.hkex.com.hk/News/Regulatory-Announcements/2024/240419news) — Hong Kong Exchanges and Clearing, April 2024
[^13]: [SGX Sustainability Reporting](https://www.sgx.com/regulation/sustainability-reporting) — Singapore Exchange
[^14]: [ESRS and ISSB Interoperability Guidance](https://www.efrag.org/en/news-and-calendar/news/ifrs-foundation-and-efrag-publish-interoperability-guidance) — EFRAG & IFRS Foundation, May 2024
