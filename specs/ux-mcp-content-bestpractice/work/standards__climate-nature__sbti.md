...
- **Scope 1+2:** Minimum 42% absolute reduction by 2030 for a 1.5°C pathway (relative to a recent base year chosen by the company)
...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://sciencebasedtargets.org/resources/files/SBTi-criteria.pdf" class="source-title">SBTi Target Validation Criteria</a>
      <div class="source-meta">SBTi | Validation Requirements</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://sciencebasedtargets.org/net-zero" class="source-title">SBTi Net-Zero Standard</a>
      <div class="source-meta">SBTi | Net-Zero Framework</div>
    </div>
  </div>
</div>
...
- [SBTi — *Corporate Net-Zero Standard*](https://sciencebasedtargets.org/net-zero) — ≥90% reduction by 2050, <10% neutralization via permanent removals, BVCM (launched October 2021)
- [SBTi — *Target Validation Criteria*](https://sciencebasedtargets.org/resources/files/SBTi-criteria.pdf) — 42% absolute Scope 1+2 reduction by 2030 for 1.5°C; ambition rules (no new 2°C targets since 2022)
- [SBTi — *Companies Taking Action*](https://sciencebasedtargets.org/companies-taking-action) — live count of committed/validated companies (7,000+ as of 2025)
- [SBTi — *Updated SME Definition and Fees*](https://sciencebasedtargets.org/news/sbti-announces-updated-sme-definition-and-fees) — target validation fee structure
- [SBTi — *Validation Services*](https://sciencebasedtargets.org/validation-services) — target submission and validation process
