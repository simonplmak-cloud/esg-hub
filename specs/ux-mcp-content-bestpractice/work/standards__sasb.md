...
SASB Standards were developed with **significant investor input** to focus on financially material information. They are used by thousands of companies and investors globally, including major asset managers like BlackRock, State Street, and Vanguard.

### IFRS Integration

In June 2022, the Value Reporting Foundation (home of SASB) merged into the IFRS Foundation. SASB Standards are now maintained by the ISSB and serve as the **industry-specific guidance** for IFRS S1 General Requirements. Companies reporting under IFRS S1/S2 are expected to reference SASB Standards for their industry.
...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://www.sasb.org/standards/" class="source-title">SASB Standards (77 Industries)</a>
      <div class="source-meta">IFRS Foundation | Industry Standards</div>
    </div>
  </div>
</div>
...
SASB uses the Sustainable Industry Classification System (SICS) to categorize companies. Find your industry standard at [sasb.ifrs.org/standards](https://sasb.ifrs.org/standards/).
...
<div class="related-grid">
  <a href="/standards/ifrs-s1-s2/" class="related-card">
    ...
    <div class="related-card-description">SASB provides industry guidance for IFRS S1</div>
  </a>
  <a href="/standards/gri/" class="related-card">
    <div class="related-card-icon">🌍</div>
    <div class="related-card-title">GRI Standards</div>
    <div class="related-card-description">Complementary impact materiality reporting</div>
  </a>
  <a href="/practice/materiality-assessment/" class="related-card">
    <div class="related-card-icon">🎯</div>
    <div class="related-card-title">Materiality Assessment</div>
    <div class="related-card-description">Identify material topics for your industry</div>
  </a>
</div>
...
- [IFRS Foundation — *SASB Standards*](https://www.ifrs.org/issued-standards/sasb-standards/) — 77 industry standards across 11 sectors, maintained by the ISSB since the June 2022 consolidation
- [SASB Standards](https://www.sasb.org/standards/) — industry-specific standards and materiality map (26 general ESG issues, 5 dimensions)
