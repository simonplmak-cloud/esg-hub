...
- **Significance to stakeholders** (Impact materiality)  
- **Financial impact on company** (Financial materiality)
...
- **ESG Reporting Made Simple (IFRS/SASB)** — SASB materiality approach
- **ESG & GRI Reporting Made Simple** — GRI materiality process
...
- [GRI Materiality Guidance](https://www.globalreporting.org/standards/)
- [EFRAG Double Materiality Guidance](https://www.efrag.org/en/sustainability-reporting)
- [ISSB Financial Materiality](https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/)
