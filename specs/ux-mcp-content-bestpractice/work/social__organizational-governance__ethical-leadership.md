...
- **Visible commitment** to ethical values and social responsibility
- **Consistent behavior** that aligns with stated values
- **Accountability** for ethical failures and willingness to take corrective action
- **Resource allocation** that prioritizes ethical conduct and stakeholder interests

### Code of Conduct and Ethics Policies

Organizations should establish clear written standards for ethical behavior:

- **Code of Conduct** — Core values, expected behaviors, and prohibited conduct
- **Anti-Corruption Policy** — Zero tolerance for bribery, facilitation payments, and conflicts of interest
- **Human Rights Policy** — Commitment to respect internationally recognized human rights
- **Supplier Code of Conduct** — Ethical expectations for business partners
- **Conflict of Interest Policy** — Disclosure and management of personal interests that may conflict with organizational duties

### Whistleblower Protection

Mechanisms that enable employees and stakeholders to report unethical conduct without fear of retaliation:

- **Anonymous reporting channels** (hotlines, online portals)
- **Non-retaliation policies** and enforcement
- **Independent investigation processes**
- **Transparent reporting** of whistleblower cases (aggregated, anonymized)

### Ethics Training and Awareness

Regular training programs that embed ethical decision-making in organizational culture:

- **Onboarding ethics training** for all new employees
- **Annual refresher training** on code of conduct
- **Scenario-based training** on ethical dilemmas
- **Leadership ethics programs** for managers and executives
- **Third-party training** for suppliers and business partners
...
- **Values alignment** — Does this decision align with our stated values?
- **Legal compliance** — Does this meet legal and regulatory requirements?
- **Public disclosure test** — Would we be comfortable if this decision were made public?
- **Long-term consequences** — What are the long-term impacts on stakeholders and reputation?
...
- [ISO 37001:2016](https://www.iso.org/standard/65034.html) — Anti-bribery management systems

### OECD Guidance
- [OECD Guidelines for Multinational Enterprises — Chapter II](https://www.oecd.org/corporate/mne/) — General policies on responsible business conduct
- [G20/OECD Principles of Corporate Governance (2023)](/standards/social-governance/oecd-cg-principles/) — Chapter V: Responsibilities of the Board

### UN Frameworks
- [UN Global Compact — Principle 10](https://www.unglobalcompact.org/what-is-gc/mission/principles/principle-10) — Anti-corruption
- [UN Convention Against Corruption (UNCAC)](https://www.unodc.org/unodc/en/corruption/uncac.html) — International anti-corruption treaty

### ESG Disclosure Standards
- [GRI 2: General Disclosures 2021](/standards/gri/) — Governance and ethics policies
- [IFRS S1: General Requirements](/standards/ifrs-s1-s2/) — Governance disclosure
...
- **ESG & GRI Reporting Made Simple** — GRI 2 governance and ethics disclosures
- **Supply Chain & Business Ethics** — Ethical conduct in supply chains and business relationships
...
- [Stakeholder-Inclusive Decision-Making](/social/organizational-governance/stakeholder-inclusiveness/) — Engaging stakeholders in governance
- [S4: Fair Operating Practices](/social/fair-operating-practices/) — Anti-corruption and fair competition
- [G5: Board Responsibilities](/governance/board-responsibilities/) — Board oversight and accountability
