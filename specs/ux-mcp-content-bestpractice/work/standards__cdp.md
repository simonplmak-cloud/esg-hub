...
CDP scores companies on a scale from **A (leadership) to D- (disclosure)**, with **F** assigned for failure to disclose:
...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://www.cdp.net/en/guidance" class="source-title">CDP Reporting Guidance</a>
      <div class="source-meta">CDP | Questionnaires & Scoring</div>
    </div>
  </div>
</div>
...
**Step 1: Register**  
Create an account at [cdp.net](https://www.cdp.net/) and register your organization. Disclosure is free for companies.
...
The climate questionnaire has **13 modules (C0–C12)**:
...
<div class="related-grid">
  <a href="/standards/tcfd/" class="related-card">
    ...
    <div class="related-card-description">CDP climate questionnaire is TCFD-aligned</div>
  </a>
  ...
  <a href="/environmental/climate-change/" class="related-card">
    ...
    <div class="related-card-description">Planetary boundary addressed by CDP</div>
  </a>
  <a href="/standards/ifrs-s1-s2/" class="related-card">
    <div class="related-card-icon">📊</div>
    <div class="related-card-title">IFRS S2</div>
    <div class="related-card-description">CDP climate data supports IFRS S2 compliance</div>
  </a>
  <a href="/environmental/water/" class="related-card">
    <div class="related-card-icon">💧</div>
    <div class="related-card-title">Water</div>
    <div class="related-card-description">CDP water security questionnaire</div>
  </a>
</div>
...
- [CDP — *Record 23,000+ companies disclose through CDP (2024)*](https://www.cdp.net/en/press-releases/record-23-000-companies-disclose-environmental-impact-through-cdp-with-urgency-for-action-clear-in-wake-of-unprecedented-global-temperatures) — 2024 disclosure count; 740+ financial institutions with $136T+; IFRS S2 alignment from 2024
- [CDP — *Scores and A Lists*](https://www.cdp.net/en/data/scores) — scoring bands (A through D-) and F for failure to disclose
- [CDP — *Corporate Disclosure: Key Changes for 2024*](https://cdn.cdp.net/cdp-production/comfy/cms/files/files/000/009/022/original/Corporate-Disclosure_Key-changes-for-2024_Part-II.pdf) — questionnaire structure and ISSB alignment
- [CDP — *Reporting Guidance*](https://www.cdp.net/en/guidance) — questionnaires and scoring methodology
- [CDP — *Supply Chain*](https://www.cdp.net/en/supply-chain) — 280+ purchasing organizations with $6.4T procurement spend
