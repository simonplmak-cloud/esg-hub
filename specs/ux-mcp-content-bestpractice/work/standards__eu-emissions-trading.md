...
- [European Commission — *EU Emissions Trading System (EU ETS)*](https://climate.ec.europa.eu/eu-action/eu-emissions-trading-system-eu-ets_en) — Phase 4 (2021–2030), −62% target vs 2005, linear reduction factor 4.3% (2024–27) / 4.4% (2028–30)
- [European Commission — *Carbon Border Adjustment Mechanism*](https://taxation-customs.ec.europa.eu/carbon-border-adjustment-mechanism_en) — CBAM scope and phase-in (reporting 2023–2026, definitive regime from 2026)
- [EUR-Lex — *Directive (EU) 2023/959 (ETS revision)*](https://eur-lex.europa.eu/eli/dir/2023/959/oj) — Fit for 55 ETS reform incl. maritime extension
