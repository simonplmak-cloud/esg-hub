...
**Key Elements**:
- Tone from the top — Board and senior management commitment
...
### ISO 26000 Guidance
- [ISO 26000:2010 — Section 6.2 Organizational Governance](https://www.iso.org/iso-26000-social-responsibility.html) — Core subject guidance
- [ISO 26000 and SDGs](https://www.iso.org/publication/PUB100401.html) — Linkages to SDG 16 (Peace, Justice, Strong Institutions)

### OECD Principles
- [G20/OECD Principles of Corporate Governance (2023)](/standards/social-governance/oecd-cg-principles/) — Chapter VI: Sustainability and Resilience
- [OECD Guidelines for Multinational Enterprises](/standards/social-governance/oecd-mne-guidelines/) — Chapter II: General Policies

### UN Frameworks
- [UN Global Compact — Principle 10](https://www.unglobalcompact.org/what-is-gc/mission/principles/principle-10) — Anti-corruption and transparency
- [UN Guiding Principles on Business & Human Rights](/standards/social-governance/ungp/) — Pillar 1: State duty to protect; Pillar 2: Corporate responsibility to respect

### ESG Disclosure Standards
- [GRI 2: General Disclosures 2021](/standards/gri/) — Governance structure and composition (GRI 2-9 to 2-20)
- [IFRS S1: General Requirements](/standards/ifrs-s1-s2/) — Governance disclosure requirements

---

## Relationship to Corporate Governance

While **corporate governance** (covered in the [Governance Hub](/governance/)) focuses on board structures, shareholder rights, and fiduciary duties, **organizational governance** in the social context emphasizes:
...
- **ESG & GRI Reporting Made Simple** — GRI 2 governance disclosures implementation
- **ESG Reporting Made Simple (IFRS/SASB)** — IFRS S1 governance requirements
...
- [Governance Hub](/governance/) — Corporate governance frameworks (G20/OECD Principles)
- [G6: Sustainability & Resilience](/governance/sustainability-resilience/) — Board oversight of sustainability
- [S4: Fair Operating Practices](/social/fair-operating-practices/) — Anti-corruption and ethical business conduct
