...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://sdgs.un.org/goals/goal1" class="source-title">SDG 1: No Poverty</a>
      <div class="source-meta">United Nations | Official SDG 1 page with targets and indicators</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.worldbank.org/en/topic/poverty" class="source-title">Poverty Overview</a>
      <div class="source-meta">World Bank | Global poverty data and analysis</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ilo.org/global/topics/wages/lang--en/index.htm" class="source-title">Wages and Working Conditions</a>
      <div class="source-meta">International Labour Organization | Living wage guidance</div>
    </div>
  </div>
</div>
...
- [Living Wage](/social/labour-practices/living-wage/)
- [Human Rights Due Diligence](/social/human-rights/due-diligence/)
- [Community Investment](/social/community/community-investment/)
...
- [UN SDGs — *Goal 1*](https://sdgs.un.org/goals/goal1) — official targets and indicators for Goal 1
