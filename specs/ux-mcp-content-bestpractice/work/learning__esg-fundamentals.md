...
1. **Understand materiality** — Identify ESG issues relevant to your industry  
2. **Choose a framework** — Select reporting standards (GRI, SASB, IFRS)  
3. **Collect data** — Establish systems for ESG data collection  
4. **Set targets** — Define measurable ESG goals  
5. **Report transparently** — Disclose progress and challenges

## From ESG Library

- **ESG Reporting Made Simple (IFRS/SASB)** — Comprehensive introduction to ESG reporting
- **ESG & GRI Reporting Made Simple** — GRI Standards implementation guide
...
- [CFA Institute ESG Investing](https://www.cfainstitute.org/en/rpc-overview/esg-investing)
- [PRI What is Responsible Investment?](https://www.unpri.org/about-PRI/what-principles-for-responsible-investment)
- [World Economic Forum ESG Resources](https://www.weforum.org/topics/esg/)
