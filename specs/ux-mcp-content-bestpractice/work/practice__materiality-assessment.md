...
[https://www.ifrs.org/issued-standards/sasb-standards/](https://www.ifrs.org/issued-standards/sasb-standards/)

**GRI Sector Standards**: Sector-specific likely material topics based on impact assessment  
[https://www.globalreporting.org/standards/sector-program/](https://www.globalreporting.org/standards/sector-program/)

**EFRAG ESRS Implementation Guidance**: Double materiality assessment process for CSRD  
[https://www.efrag.org/en/sustainability-reporting](https://www.efrag.org/en/sustainability-reporting)

**WEF Stakeholder Capitalism Metrics**: Common metrics for material ESG topics  
[https://www.weforum.org/stakeholdercapitalism](https://www.weforum.org/stakeholdercapitalism)
...
<div class="related-grid">
  <a href="/practice/stakeholder-engagement/" class="related-card">
    <div class="related-card-icon">👥</div>
    <div class="related-card-title">Stakeholder Engagement</div>
    <div class="related-card-description">Essential input for materiality assessment</div>
  </a>
  
  <a href="/standards/gri/" class="related-card">
    <div class="related-card-icon">📊</div>
    <div class="related-card-title">GRI Standards</div>
    <div class="related-card-description">GRI 3 provides impact materiality guidance</div>
  </a>
  
  <a href="/standards/ifrs-s1-s2/" class="related-card">
    <div class="related-card-icon">📈</div>
    <div class="related-card-title">IFRS S1 & S2</div>
    <div class="related-card-description">Financial materiality for investor decisions</div>
  </a>
</div>
...
- [GRI — *GRI 3: Material Topics 2021*](https://www.globalreporting.org/standards/standards-development/universal-standards/) — impact materiality process
- [IFRS — *IFRS S1*](https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s1-general-requirements/) — financial materiality
- [EFRAG — *ESRS 1*](https://www.efrag.org/en/sustainability-reporting) — double materiality methodology
