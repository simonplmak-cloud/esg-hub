...
| **European Union** | Corporate Sustainability Reporting Directive (CSRD) with ESRS E1 | Mandatory for in-scope companies (Wave 1 FY2024; scope narrowed by 2025 Omnibus) |
...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://www.fsb-tcfd.org/recommendations/" class="source-title">TCFD Recommendations (2017)</a>
      <div class="source-meta">Financial Stability Board | Final Report</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.fsb.org/2023/10/2023-tcfd-status-report-task-force-on-climate-related-financial-disclosures/" class="source-title">2023 TCFD Status Report</a>
      <div class="source-meta">FSB | Final Status Report</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.fsb-tcfd.org/publications/" class="source-title">TCFD Publications</a>
      <div class="source-meta">FSB-TCFD | Implementation Guidance and Sector Supplements</div>
    </div>
  </div>
  ...
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s2-climate-related-disclosures/" class="source-title">IFRS S2 Climate-related Disclosures</a>
      <div class="source-meta">ISSB | Builds on TCFD framework</div>
    </div>
  </div>
</div>
...
<div class="book-card">
  ...
  <div class="book-info">
    ...
    <div class="book-description">Comprehensive guide to IFRS S2 Climate-related Disclosures, which builds directly on TCFD framework. Includes scenario analysis templates, Scope 3 calculation methodologies, and SASB climate metrics integration.</div>
...
<div class="book-card">
  ...
  <div class="book-info">
    ...
    <div class="book-description">While focused on GRI Standards, includes mapping between GRI 305 (Emissions) and TCFD Metrics and Targets pillar for integrated climate reporting.</div>
    <a href="/books/" class="book-download">View Book Details</a>
  </div>
</div>
...
<div class="related-grid">
  <a href="/standards/ifrs-s1-s2/" class="related-card">
    ...
    <div class="related-card-description">IFRS S2 builds directly on TCFD framework</div>
  </a>
  
  <a href="/standards/tnfd/" class="related-card">
    <div class="related-card-icon">🦋</div>
    <div class="related-card-title">TNFD</div>
    <div class="related-card-description">Nature-related disclosures modeled on TCFD structure</div>
  </a>
  
  <a href="/standards/climate-nature/ghg-protocol/" class="related-card">
    <div class="related-card-icon">📏</div>
    <div class="related-card-title">GHG Protocol</div>
    <div class="related-card-description">Standard for calculating Scope 1-3 emissions (TCFD Metrics pillar)</div>
  </a>
  ...
  <a href="/environmental/climate-change/" class="related-card">
    ...
    <div class="related-card-description">Planetary boundary addressed by TCFD framework</div>
  </a>
  
  <a href="/hk-apac/hkex-esg-code/" class="related-card">
    <div class="related-card-icon">🇭🇰</div>
    <div class="related-card-title">HKEX ESG Code</div>
    <div class="related-card-description">Mandates TCFD-aligned climate disclosures (FY2025+)</div>
  </a>
  
  <a href="/standards/sasb/" class="related-card">
    <div class="related-card-icon">🏭</div>
    <div class="related-card-title">SASB Standards</div>
    <div class="related-card-description">Industry-specific climate metrics aligned with TCFD</div>
  </a>
</div>
...
- [FSB-TCFD — *About the TCFD*](https://www.fsb-tcfd.org/about/) — framework history; remit completed and disbanded October 2023
- [TCFD — *Recommendations (2017, final report)*](https://www.fsb-tcfd.org/recommendations/) — 11 recommended disclosures across four pillars
- [IFRS Foundation — *IFRS S2 Climate-related Disclosures*](https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s2-climate-related-disclosures/) — TCFD incorporated into the ISSB baseline; ISSB monitoring from 2024
