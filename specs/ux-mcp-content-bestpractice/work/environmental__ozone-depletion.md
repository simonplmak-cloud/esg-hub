...
- **[Montreal Protocol on Substances that Deplete the Ozone Layer (1987)](https://ozone.unep.org/treaties/montreal-protocol)** — Legally binding treaty
- **[Kigali Amendment (2016)](https://ozone.unep.org/treaties/montreal-protocol)** — HFC phase-down

### Disclosure Standards
- **[GRI 305](/standards/gri/)** — Emissions (includes ODS in Scope 1)
- **[EU F-Gas Regulation](https://climate.ec.europa.eu/eu-action/fluorinated-greenhouse-gases_en)** — HFC phase-down in EU
...
- [UN Environment Ozone Secretariat](https://ozone.unep.org/) — Montreal Protocol implementation
- [WMO/UNEP Ozone Assessment (2022)](https://ozone.unep.org/scientific-assessment-ozone-depletion-2022) — Scientific status report
- [NASA Ozone Watch](https://ozonewatch.gsfc.nasa.gov/) — Real-time ozone hole monitoring

### Policy Frameworks
- [Montreal Protocol Text](https://ozone.unep.org/treaties/montreal-protocol) — Full treaty document
- [Kigali Amendment Text](https://ozone.unep.org/treaties/montreal-protocol)
...
- [Climate Change](/environmental/climate-change/) — HFCs as potent GHGs
- [Novel Entities](/environmental/novel-entities/) — Chemical substances regulation

---

<small>Planetary Boundary Status: Stockholm Resilience Centre (2023) | Ozone Recovery: WMO/UNEP (2022) | Last updated: February 2026</small>
