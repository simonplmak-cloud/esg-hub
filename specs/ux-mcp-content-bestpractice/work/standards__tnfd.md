...
<div class="source-list">
  <div class="source-item">
    ...
    <div class="source-info">
      <a href="https://tnfd.global/recommendations/" class="source-title">TNFD Recommendations (September 2023)</a>
      <div class="source-meta">TNFD | Final Framework</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://tnfd.global/guidance/" class="source-title">TNFD Additional Guidance</a>
      <div class="source-meta">TNFD | Sector guidance, scenarios, metrics</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://www.ipbes.net/global-assessment" class="source-title">IPBES Global Assessment Report on Biodiversity</a>
      <div class="source-meta">Intergovernmental Science-Policy Platform on Biodiversity and Ecosystem Services | Authoritative assessment of nature loss</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://sciencebasedtargetsnetwork.org/" class="source-title">Science Based Targets Network (SBTN)</a>
      <div class="source-meta">SBTN | Science-based targets for nature (complements TNFD)</div>
    </div>
  </div>
  <div class="source-item">
    <div class="source-icon">📄</div>
    <div class="source-info">
      <a href="https://encore.naturalcapital.finance/" class="source-title">ENCORE Tool</a>
      <div class="source-meta">Natural Capital Finance Alliance | Explore dependencies and impacts by sector</div>
    </div>
  </div>
</div>
...
<div class="related-grid">
  <a href="/standards/tcfd/" class="related-card">
    ...
    <div class="related-card-description">TNFD mirrors TCFD structure</div>
  </a>
  
  <a href="/environmental/biodiversity-loss/" class="related-card">
    <div class="related-card-icon">🦋</div>
    <div class="related-card-title">Biodiversity Loss</div>
    <div class="related-card-description">Planetary boundary addressed by TNFD</div>
  </a>
</div>
...
- [TNFD — *Recommendations of the Taskforce on Nature-related Financial Disclosures (September 2023)*](https://www.tnfd.global/wp-content/uploads/2023/08/Recommendations_of_the_Taskforce_on_Nature-related_Financial_Disclosures_September_2023.pdf) — 14 recommended disclosures, four pillars
- [TNFD — *The LEAP Approach*](https://tnfd.global/publication/additional-guidance-on-assessment-of-nature-related-issues-the-leap-approach/) — Locate, Evaluate, Assess, Prepare
